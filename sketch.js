...
function setup() {
	...
	//create mango here 
	  ...
	  mango2 = new Mango(883,200,50,50);
    mango3 = new Mango(815,255,50,50);
    mango4 = new Mango(752,293,50,50);
    mango5 = new Mango(980,250,50,50);

    //create stone here 
    stone1 = new Stone(192,600,50,50);
